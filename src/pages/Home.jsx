  ...
  return (
    <div className="col-md-3 col-6">
      <div className="card shadow-sm mb-3">
        <img src={image} className="card-img-top" alt="..."onClick={handleProductClick} style={{ cursor: 'pointer' }} />
        <div className="card-body">
          <h5 className="card-title" onClick={handleProductClick} style={{ cursor: 'pointer' }}>{name}</h5>
          <p className="card-text" onClick={handleProductClick} style={{ cursor: 'pointer' }}>{description}</p>
          <p>
            <span style={{ textDecoration: "line-through" }}>Rs.{price}</span>
            <span className="fw-bold" onClick={handleProductClick} style={{ cursor: 'pointer' }}>Rs.{discountedPrice}</span>
